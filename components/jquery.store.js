(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Clothings-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.paypalBusinessEmail = "omwelemasyrile@email.com"; // Your Business PayPal's account email address
